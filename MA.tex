...
\newcommand{\tmd}{\textsc{tmdc}}
\newcommand{\tmdg}{\textsc{tmdc}\ }
\newcommand{\tmds}{\textsc{tmdc}s\ }
...
\newcommand{\wse}{WSe$_{2}$\ }
\newcommand{\mos}{MoS$_{2}$\ }
%\newcommand{\mos}{\textsc{m}o\textsc{s}$_{\scaleto{2}{4pt}}$\ }
\newcommand{\mose}{MoSe$_{2}$\ }
...
%\newcommand{\titleen}{Scalar wave emission\\ prove the sun is cold}
%\newcommand{\titlede}{Magie ist physik\\ durch wollen}
\newcommand{\titleen}{Spectroscopy of gate-tunable\\ thin films of tungsten-diselenide}
\newcommand{\titlede}{Spektroskopie ladungsdurchstimmbarer\\ dünner schichten aus wolfram-diselenid}
